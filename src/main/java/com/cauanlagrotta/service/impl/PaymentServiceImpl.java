...
public class PaymentServiceImpl implements PaymentService {
  ...
  public PaymentLinkResponse createOrder(
    ...
    if (paymentMethod == PaymentMethod.RAZORPAY) {
      PaymentLink payment =
          createRazorpayPaymentLink(user, savedOrder.getAmount(), savedOrder.getId());
      ...
      String paymentUrl =
          createStripePaymentLink(user, savedOrder.getAmount(), savedOrder.getId());
  ...
  public PaymentOrder getPaymentOrderById(Long paymentOrderId) {
    ...
    PaymentOrder paymentOrder = paymentOrderRepository.findById(paymentOrderId).orElse(null);
  ...
  public PaymentLink createRazorpayPaymentLink(
      UserDTO user, Long amount, Long orderId)
    ...
    paymentLinkRequest.put("amount", amountCents);
  ...
  public String createStripePaymentLink(
      UserDTO user, Long amount, Long orderId) throws StripeException {
